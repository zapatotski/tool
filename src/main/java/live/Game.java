...
public class Game implements Serializable {
   ...
   public Game(String time, String team1, String team2, String htScore, String ftScore, Map<Integer,Player> yellow1, Map<Integer,Player> yellowred1, Map<Integer,Player> red1, Map<Integer,Player> subs1, Map<Integer,Player> yellow2, Map<Integer,Player> yellowred2, Map<Integer,Player> red2, Map<Integer,Player> subs2) {
      this.time = time;
      this.team1 = team1;
      this.team2 = team2;
   ...
   public String toString() {
      ...
      return (this.team1.replace(" ", "") + this.team2.replace(" ", "")).replace(" ", "").replace(".", "").replace("-", "").replace("`", "").replace("&", "");
   }
}
